    ...
    return (
        <article>
            ...
            <div className="entry">
                ...
                <span className="country-header">JAPAN</span>

                <a href="https://www.google.com/maps/place/Mount+Fuji/@35.3606421,138.7170637,15z/data=!3m1!4b1!4m6!3m5!1s0x6019629a42fdc899:0xa6a1fcc916f3a4df!8m2!3d35.3606255!4d138.7273634!16zL20vMGNrczA?entry=ttu" className="map">View in Google Maps</a>

                <h2 className="location">Mount Fuji</h2>

                <h2 className="dates">12 Jan, 2021 - 24 Jan, 2021</h2>
